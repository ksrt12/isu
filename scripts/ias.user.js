...
function countMarks(mark) {
    rating[mark] += 1;
}
function getDiploma() {
    let dip = 0;
    const diptext = document.querySelectorAll("h4").item(table_num + 2).previousElementSibling.previousElementSibling.innerText.toLowerCase();
